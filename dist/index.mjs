...
function ContactForm({
  ...
  if (!projectId) {
    return /* @__PURE__ */ jsx("div", { className: "ecf-wrap", "data-theme": dataTheme, children: /* @__PURE__ */ jsxs("div", { className: "ecf-fatal", children: [
  ...
  const formNode = done ? /* @__PURE__ */ jsx("div", { className: wrapClass, "data-theme": dataTheme, style, children: /* @__PURE__ */ jsx("div", { className: "ecf-success", children: "\u2713 Thanks! Your message has been sent." }) }) : /* @__PURE__ */ jsxs(
    "form",
    {
      className: wrapClass,
  ...
  if (dataLayout === "page") {
    return /* @__PURE__ */ jsxs("section", { className: "ecf-page", "data-theme": dataTheme, children: [
