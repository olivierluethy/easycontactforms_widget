...
//  Layout
// ──────────────────────────────────────────────────────────────────────────
// The form is always horizontally centered with a small horizontal gutter.
// For dedicated contact pages where the form is the page's main content,
// opt into the full-page layout via `data-easycontact-layout="page"` and
// optionally provide a heading and description:
//
...
(function () {
  ...
  var STYLES = [
    ...
    '}',
    '.ecf-wrap{',
      'max-width:480px;margin-inline:auto;padding-inline:16px;width:100%;',
  ...
  function buildForm(projectToken, theme, host) {
  ...
  function mount(target, projectToken) {
    ...
    var form = buildForm(projectToken, theme, target);
